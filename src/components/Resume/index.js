    ...
    <>
      ...
      <Container>
        ...
        <section>
          ...
          <div>
            <p className='resume_p_title'>Game Seeker: <a href='https://github.com/chazgraham/Game-Seeker'>https://github.com/chazgraham/Game-Seeker</a> | <a href='https://game-seeker.herokuapp.com/'>https://game-seeker.herokuapp.com/</a></p>
            <ul>
          ...
          <div>
            <p className='resume_p_title'>Foodies: <a href='https://github.com/chazgraham/Foodies'>https://github.com/chazgraham/Foodies</a> | <a href='http://chazgraham.github.io/Foodies'>http://chazgraham.github.io/Foodies</a></p>
            <ul>
              <li>An application that allows the user to search for food recipes using the third party spoonacular API. The application will have a short summary as well as steps to complete the recipe.</li>
              <li>I was fully responsible for all aspects of the application down to styling, as well as API calls from the third-party API</li>
              <li>Technologies Used: React, JavaScript, Bootstrap</li>
            </ul>
          </div>
          <div>
            <p className='resume_p_title'>The Collective: <a href='https://github.com/DXHASE/Collective-Social-App'>https://github.com/DXHASE/Collective-Social-App</a> | <a href='https://social-collective-app.herokuapp.com/'>https://social-collective-app.herokuapp.com/</a></p>
            <ul>
